...
// 定义站点语言
const SITE_LANG = "zh_CN"; // 语言代码：'zh_CN'(简体中文), 'zh_TW'(繁体), 'en'(英文), 'ja'(日文)
...
export const siteConfig: SiteConfig = {
	...
	themeColor: {
		hue: 300, // 紫色相：调为300更纯更深的紫色
		fixed: false, // 对访问者隐藏主题色选择器
	},

	// 特色页面开关配置（关闭未使用的页面有助于提升 SEO，关闭后请记得在 navbarConfig 中移除对应链接）
	featurePages: {
		anime: false, // 番剧页面开关 (不追番，已关闭)
		diary: true, // 日记页面开关
		friends: true, // 友链页面开关
	...
	links: [
		...
		// 支持自定义导航栏链接，支持多级菜单
		{
			...
			children: [
				{
					name: "GitHub",
					url: "https://github.com/Zatops",
					external: true,
					icon: "fa7-brands:github",
				},
				{
					name: "Bilibili",
					url: "https://space.bilibili.com/435356679",
					external: true,
...
export const profileConfig: ProfileConfig = {
	avatar: "assets/images/avatar.webp", // 头像图片路径，可替换成自己的
	name: "Zatops",
	bio: "一个挣扎求生的普通人✨",
	typewriter: {
...
export const pioConfig: import("./types/config").PioConfig = {
	...
	position: "left", // 模型位置 (屏幕左边)
	width: 280, // 默认宽度
	height: 250, // 默认高度
	mode: "draggable", // 默认可拖拽模式，鼠标点住可以拖动位置
	hiddenOnMobile: true, // 默认在移动设备上隐藏
	dialog: {
		welcome: "欢迎来到 Zatops 的博客！", // 欢迎词
		touch: [
			"你在干什么呀？",
			"不要摸我啦！",
			"变态！",
		...
		home: "点我可以返回首页哦！", // 首页提示
		skin: ["想看看我的新衣服吗？", "新裙子好看~"], // 换装提示
		close: "QWQ 下次再见~", // 关闭提示
		link: "https://github.com/Zatops", // 关于链接改成了你的 GitHub
	},
};
